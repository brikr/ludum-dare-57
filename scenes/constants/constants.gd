...
const WORLD_GEN_BASE := {
  Tile.TileType.STONE: {
    ...
    WORLD_GEN_FIELDS.MAX_DEPTH : MAX_GEN_DEPTH,
    WORLD_GEN_FIELDS.MIN_COEFFICIENT : 0.5,
    WORLD_GEN_FIELDS.MAX_COEFFICIENT : 2.0,
    WORLD_GEN_FIELDS.THRESHOLD: 0.5,
  },
  Tile.TileType.EMPTY: {
    WORLD_GEN_FIELDS.MIN_DEPTH : 11,
    WORLD_GEN_FIELDS.MAX_DEPTH : MAX_GEN_DEPTH,
    WORLD_GEN_FIELDS.MIN_COEFFICIENT : 0.9,
    WORLD_GEN_FIELDS.MAX_COEFFICIENT : 1.1,
    WORLD_GEN_FIELDS.THRESHOLD: 0.63,
  }
}

const WORLD_GEN_RESOURCES := {
  Tile.TileObjectType.GOLD: {
    WORLD_GEN_FIELDS.MIN_DEPTH : 2,
...
const OBJECT_VALUE: Dictionary[Tile.TileObjectType, float] = {
  ...
  Tile.TileObjectType.ALIEN_SKULL: 2000.0,
  Tile.TileObjectType.ALIEN_TECH: 5000.0,
}
